...
const fetchVoucher = async () => {
  try {
    const res = await axios.get(`http://localhost:8080/api/vouchers/${voucherId}`)
...
const updateVoucher = async () => {
  try {
    ...
    const res = await axios.put(`http://localhost:8080/api/vouchers/update/${voucherId}`, payload);
